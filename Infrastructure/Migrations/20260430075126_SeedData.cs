        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                BEGIN
                    ...
                    ('BOOKING_STATUS',      'WAITING',      N'รอคิว',                           'Waiting',          1, GETDATE()),
            ...
            string sqlMock = $@"
                ...
                -- =====================================================
                -- ADDRESSES (2 ที่อยู่: ร้าน + สาขา 2)
                -- =====================================================
                ...
                -- =====================================================
                -- USERS (Admin=4, Owner=1, Staff=3, Customer=2, Customer2=5)
                -- =====================================================
                ...
                BEGIN
                    -- Admin: Local login พร้อม PasswordHash (PBKDF2)
                ...
                -- =====================================================
                -- USER SESSIONS (ตัวอย่าง active session)
                -- =====================================================
                ...
                BEGIN
                    INSERT INTO ShopStaffs (Id, ShopId, UserId, Role, IsActive, CreatedAt, CreatedBy) VALUES
                    (1, 1, 1, 'Owner', 1, GETDATE(), 1),
                    (2, 1, 3, 'Staff', 1, GETDATE(), 1);
                END
                ...
                BEGIN
                    INSERT INTO ShopSettings (ShopId, [Key], Value, CreatedAt, CreatedBy) VALUES
                    (1, 'MAX_QUEUE_PER_SLOT',    '50',     GETDATE(), 1),
                    (1, 'QUEUE_RESET_DAILY',     'true',   GETDATE(), 1),
                    (1, 'ALLOW_WALK_IN',         'true',   GETDATE(), 1),
                    (1, 'NOTIFY_BEFORE_MINUTES', '15',     GETDATE(), 1),
                    (1, 'CURRENCY',              'THB',    GETDATE(), 1);
                END

                -- =====================================================
                -- SHOP BUSINESS HOURS (จ-ศ 09:00-18:00, ส-อา 10:00-16:00)
                -- DayOfWeek: 0=Sun, 1=Mon, ... 6=Sat
                -- =====================================================
                IF NOT EXISTS (SELECT 1 FROM ShopBusinessHours WHERE ShopId = 1)
                BEGIN
                    INSERT INTO ShopBusinessHours (ShopId, BranchId, DayOfWeek, OpenTime, CloseTime, IsActive, CreatedAt, CreatedBy) VALUES
                    (1, 1, 1, '09:00', '18:00', 1, GETDATE(), 1),
                    (1, 1, 2, '09:00', '18:00', 1, GETDATE(), 1),
                    (1, 1, 3, '09:00', '18:00', 1, GETDATE(), 1),
                    (1, 1, 4, '09:00', '18:00', 1, GETDATE(), 1),
                    (1, 1, 5, '09:00', '18:00', 1, GETDATE(), 1),
                    (1, 1, 6, '10:00', '16:00', 1, GETDATE(), 1),
                    (1, 1, 0, '10:00', '14:00', 1, GETDATE(), 1),
                    (1, 2, 1, '09:00', '18:00', 1, GETDATE(), 1),
                    (1, 2, 2, '09:00', '18:00', 1, GETDATE(), 1),
                    (1, 2, 3, '09:00', '18:00', 1, GETDATE(), 1),
                    (1, 2, 4, '09:00', '18:00', 1, GETDATE(), 1),
                    (1, 2, 5, '09:00', '18:00', 1, GETDATE(), 1),
                    (1, 2, 6, '10:00', '16:00', 1, GETDATE(), 1);
                    -- สาขา 2 หยุดวันอาทิตย์ (ไม่ insert DayOfWeek=0)
                END
                ...
                BEGIN
                    INSERT INTO ShopHolidays (ShopId, HolidayDate, Reason, CreatedAt, CreatedBy) VALUES
                    (1, CAST(DATEADD(day, 7,  GETDATE()) AS DATE), N'วันหยุดพิเศษ - ปีใหม่', GETDATE(), 1),
                    (1, CAST(DATEADD(day, 14, GETDATE()) AS DATE), N'วันหยุดพิเศษ - สงกรานต์', GETDATE(), 1);
                END
                ...
                BEGIN
                    INSERT INTO ServiceCategories (Id, ShopId, Name, IsActive, CreatedAt, CreatedBy) VALUES
                    (1, 1, N'บริการทั่วไป',       1, GETDATE(), 1),
                    (2, 1, N'บริการเฉพาะทาง',     1, GETDATE(), 1),
                    (3, 1, N'บริการพรีเมียม',      1, GETDATE(), 1);
                END
                ...
                BEGIN
                    INSERT INTO QueueCategories (Id, ShopId, Prefix, Name, Description, IsActive, CreatedAt, CreatedBy) VALUES
                    (1, 1, 'A', N'คิวทั่วไป',    N'คิวสำหรับผู้ป่วยทั่วไป',  1, GETDATE(), 1),
                    (2, 1, 'B', N'คิวเร่งด่วน',  N'คิวสำหรับเคสเร่งด่วน',    1, GETDATE(), 1),
                    (3, 1, 'P', N'คิว VIP',       N'คิวสำหรับสมาชิก Premium',  1, GETDATE(), 1);
                END
                ...
                BEGIN
                    INSERT INTO Services (Id, Guid, ShopId, Name, Duration, Price, IsActive, CreatedAt, CreatedBy) VALUES
                    (1, '{guids.Service1}', 1, N'ตรวจร่างกายทั่วไป',       30,   0.00,    1, GETDATE(), 1),
                    (2, '{guids.Service2}', 1, N'ตรวจเลือด / Lab',         60, 500.00,    1, GETDATE(), 1),
                    (3, '{guids.Service3}', 1, N'ปรึกษาแพทย์เฉพาะทาง',    45, 800.00,    1, GETDATE(), 1);
                END
                ...
                BEGIN
                    ...
                    (1, 1, GETDATE(), 1), -- ตรวจทั่วไป → บริการทั่วไป
                    (2, 2, GETDATE(), 1), -- ตรวจเลือด  → บริการเฉพาะทาง
                    (3, 2, GETDATE(), 1), -- ปรึกษาแพทย์→ บริการเฉพาะทาง
                    (3, 3, GETDATE(), 1); -- ปรึกษาแพทย์→ บริการพรีเมียม (multi-category)
                END

                -- =====================================================
                -- SERVICE STAFF MAPS (staff ให้บริการได้)
                -- =====================================================
                ...
                BEGIN
                    ...
                    (1, 1, GETDATE(), 1), -- ตรวจทั่วไป  → Owner
                    (1, 2, GETDATE(), 1), -- ตรวจทั่วไป  → Staff
                    (2, 2, GETDATE(), 1), -- ตรวจเลือด   → Staff
                    (3, 1, GETDATE(), 1); -- ปรึกษาแพทย์ → Owner
                END

                -- =====================================================
                -- QUEUE SLOTS (วันนี้ + พรุ่งนี้)
                -- =====================================================
                ...
                BEGIN
                    ...
                    (1, NEWID(), 1, 1, CAST(GETDATE() AS DATE),                '09:00', '12:00', 30, 2, 1, GETDATE(), 1),
                    (2, NEWID(), 1, 1, CAST(GETDATE() AS DATE),                '13:00', '18:00', 30, 0, 1, GETDATE(), 1),
                    (3, NEWID(), 1, 2, CAST(GETDATE() AS DATE),                '09:00', '12:00', 20, 1, 1, GETDATE(), 1),
                    (4, NEWID(), 1, 1, CAST(DATEADD(day,1,GETDATE()) AS DATE), '09:00', '12:00', 30, 0, 1, GETDATE(), 1),
                    (5, NEWID(), 1, 1, CAST(DATEADD(day,1,GETDATE()) AS DATE), '13:00', '18:00', 30, 0, 1, GETDATE(), 1);
                END
                ...
                BEGIN
                    INSERT INTO Bookings (Id, Guid, UserId, ShopId, BranchId, QueueSlotId, QueueCategoryId, QueueNumber, Remark, StatusId, CreatedAt, CreatedBy) VALUES
                    (1, '{guids.Booking1}', 2, 1, 1, 1, 1, 1, N'ขอนัดคุณหมอด้านอายุรกรรม',
                        (SELECT TOP 1 Id FROM MasterStatuses WHERE Type='BOOKING_STATUS' AND Code='CONFIRMED'), GETDATE(), 2),
                    (2, '{guids.Booking2}', 5, 1, 1, 1, 1, 2, NULL,
                        (SELECT TOP 1 Id FROM MasterStatuses WHERE Type='BOOKING_STATUS' AND Code='WAITING'), GETDATE(), 5),
                    (3, '{guids.Queue1}',   2, 1, 2, 3, 2, 1, N'เร่งด่วน - ปวดท้องรุนแรง',
                        (SELECT TOP 1 Id FROM MasterStatuses WHERE Type='BOOKING_STATUS' AND Code='DONE'), DATEADD(day,-1,GETDATE()), 2),
                    (4, '{guids.Queue2}',   5, 1, 1, 2, 1, 3, NULL,
                ...
                BEGIN
                    ...
                    (1, 1, GETDATE(), 2), -- Booking 1 → ตรวจทั่วไป
                    (1, 3, GETDATE(), 2), -- Booking 1 → ปรึกษาแพทย์ (multi-service)
                    (2, 1, GETDATE(), 5), -- Booking 2 → ตรวจทั่วไป
                    (3, 2, GETDATE(), 2), -- Booking 3 → ตรวจเลือด
                    (4, 1, GETDATE(), 5); -- Booking 4 → ตรวจทั่วไป
                END
                ...
                BEGIN
                    INSERT INTO Queues (Id, Guid, ShopId, BranchId, QueueNumber, StatusId, Type, CreatedAt, CreatedBy) VALUES
                    (1, NEWID(), 1, 1, 1, (SELECT TOP 1 Id FROM MasterStatuses WHERE Type='QUEUE_STATUS' AND Code='SERVING'), 'WALK_IN',  GETDATE(), NULL),
                    (2, NEWID(), 1, 1, 2, (SELECT TOP 1 Id FROM MasterStatuses WHERE Type='QUEUE_STATUS' AND Code='WAITING'), 'BOOKING',  GETDATE(), 2),
                    (3, NEWID(), 1, 2, 1, (SELECT TOP 1 Id FROM MasterStatuses WHERE Type='QUEUE_STATUS' AND Code='DONE'),    'WALK_IN',  DATEADD(hour,-2,GETDATE()), NULL),
                    (4, NEWID(), 1, 1, 3, (SELECT TOP 1 Id FROM MasterStatuses WHERE Type='QUEUE_STATUS' AND Code='WAITING'), 'BOOKING',  GETDATE(), 5);
                END
                SET IDENTITY_INSERT Queues OFF;

                -- =====================================================
                -- QUEUE LOGS (ประวัติสถานะคิว)
                -- =====================================================
                ...
                -- =====================================================
                -- CUSTOMERS (Customer profile ของ Shop)
                -- =====================================================
                ...
                -- =====================================================
                -- PAYMENTS (สำหรับ Booking ที่ DONE)
                -- =====================================================
                ...
                -- =====================================================
                -- 4. เปิด Constraint ทั้งหมดและตรวจสอบความถูกต้อง
                -- =====================================================
