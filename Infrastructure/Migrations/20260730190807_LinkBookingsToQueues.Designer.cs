...
namespace Queue.Infrastructure.Migrations
{
    ...
    [Migration("20260730190807_LinkBookingsToQueues")]
    partial class LinkBookingsToQueues
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Queue.Domain.Entities.Queue", b =>
                {
                    ...
                    b.HasIndex(new[] { "BookingId" }, "IX_Queues_BookingId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Queue.Domain.Entities.Queue", b =>
                {
                    ...
                    b.HasOne("Queue.Domain.Entities.Booking", "Booking")
                        .WithOne("Queue")
                        .HasForeignKey("Queue.Domain.Entities.Queue", "BookingId")
                        .OnDelete(DeleteBehavior.SetNull)
