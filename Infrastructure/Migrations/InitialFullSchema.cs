        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    // เช่น USER_STATUS / BOOKING_STATUS
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    // ✅ FIX: เพิ่ม FK ไปยัง MasterStatuses
                ...
                constraints: table =>
                {
                    ...
                    // ✅ FIX: FK ที่หายไปในของเดิม
                    table.ForeignKey("FK_Users_Status", x => x.StatusId, "MasterStatuses", "Id");
                });

            // ✅ FIX: สร้าง index ครั้งเดียว (ของเดิมสร้างซ้ำ 2 ครั้ง)
            migrationBuilder.CreateIndex(
                name: "IX_Users_Email",
                table: "Users",
                column: "Email");
            ...
            // ✅ FIX: เปลี่ยนจาก IsPrimary index เดี่ยว เป็น composite index (low-cardinality bool ไม่ควร index เดี่ยว)
            migrationBuilder.CreateIndex(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    // nullable: true เพราะ Provider = "Google" จะไม่มี PasswordHash
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    // เก็บค่า Hash ของ Refresh Token
                    RefreshToken = table.Column<string>(nullable: true),
                    // เก็บค่า Salt สำหรับ Verify Refresh Token
            ...
            // ✅ FIX: กัน staff ซ้ำใน shop เดียวกัน
            migrationBuilder.CreateIndex(
            ...
            // ✅ FIX: กัน slot ซ้ำในสาขา/วัน/เวลาเดียวกัน
            migrationBuilder.CreateIndex(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    // ✅ FIX: เปลี่ยนเป็น int ให้ตรงกับ Queues.QueueNumber
            ...
            // ✅ FIX: กัน customer ซ้ำใน shop เดียวกัน
            migrationBuilder.CreateIndex(
