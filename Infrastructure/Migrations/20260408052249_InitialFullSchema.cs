...

        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    // ✅ เพิ่ม
                    EmailConfirmed = table.Column<bool>(defaultValue: false),
            ...
            migrationBuilder.CreateTable(
...

                {
                    ...
                    table.ForeignKey("FK_URM_User", x => x.UserId, "Users", "Id", onDelete: ReferentialAction.NoAction);

                    table.ForeignKey("FK_URM_Role", x => x.RoleId, "UserRoles", "Id", onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
...

                {
                    ...
                    // 🌟 เพิ่มคอลัมน์เก็บค่า Salt สำหรับ Verify Refresh Token
            ...
            // UNIQUE INDEX FOR GUIDS (เพื่อให้ตอนเอาไปค้นหาผ่าน API เร็วขึ้น)
