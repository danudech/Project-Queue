...
public interface IChatService
{
    ...
    Task<List<ChatMessageResponse>> GetShopMessagesAsync(int userId, int conversationId, CancellationToken ct);
    Task<ChatMessageResponse> SendShopMessageAsync(int userId, int conversationId, SendChatMessageRequest request, CancellationToken ct);
    ...
    Task<ChatConversationResponse> AcceptConversationAsync(int userId, int conversationId, CancellationToken ct);
}
